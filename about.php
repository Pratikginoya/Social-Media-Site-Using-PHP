								...
								<aside class="sidebar static">
									...
									<ul class="naves">
										...
										<li>
											...
											<a title="" href="edit-work-eductation.php">Education &amp; Work</a>
										</li>
										<li>
											<i class="ti-heart"></i>
											<a title="" href="edit-interest.php">My interests</a>
										</li>
										<li>
											<i class="ti-settings"></i>
											<a title="" href="edit-account-setting.php">account setting</a>
										</li>
										<li>
											<i class="ti-lock"></i>
